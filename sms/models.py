...
class TeuleHouses(models.Model):
    ...
    house_number = models.CharField(max_length=250, unique=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    last_fine_date = models.DateTimeField(auto_now=True,default=datetime.now)
    ...
    amount_0 = models.FloatField(max_length=250, default=0,null=True)
    amount_1 = models.FloatField(max_length=250, default=0,null=True)
    amount_2 = models.FloatField(max_length=250, default=0,null=True)
    amount_3 = models.FloatField(max_length=250, default=0,null=True)
    amount_4 = models.FloatField(max_length=250, default=0,null=True)
    amount_5 = models.FloatField(max_length=250, default=0,null=True)
    amount_6 = models.FloatField(max_length=250, default=0,null=True)
...
class TeuleMeterReplacement(models.Model):
...
class TeuleMeterReadingSmsRaw(models.Model):
    names = models.CharField(max_length=250)
    msisdn = models.CharField(max_length=250)    
    account_number = models.ForeignKey(TeuleClients, on_delete=models.CASCADE)
    id_num = models.CharField(max_length=250, null=True)
    ...
    class Meta:
        verbose_name = 'teule_meterreading'
        verbose_name_plural = 'teule_meterreadings'


class TeuleStatement(models.Model):
    ...
    class Meta:
        verbose_name = 'teule_statement'
        verbose_name_plural = 'teule_statements'

class TeuleBillSent(models.Model):
...
class TeuleMeterReadings(models.Model):
    ...
    id_num = models.CharField(max_length=250, null=True)
    meter_num = models.CharField(max_length=250, null=True)
    monthly_rent = models.CharField(max_length=250, default=0,null=True)
    customer_rate = models.CharField(max_length=250, null=True)
    reading_type = models.CharField(max_length=250, null=True)
    read_by = models.CharField(max_length=250, null=True)
    last_meter_reading_date = models.CharField(max_length=250, null=True)
